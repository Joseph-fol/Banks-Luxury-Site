    ...
    return (
        <>
            <div className="bg-base-200 min-h-screen py-10 lg:py-20 w-full overflow-hidden">
                <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-10 lg:gap-20 items-center`}>
                    <div className="w-full lg:flex-1 flex justify-start">
                        {image}
                    </div>

                    <div className={`bg-base-10 w-full lg:flex-1 shrink-0 my-10 lg:my-20 px-4 md:px-12 ${reverse ? 'lg:pl-20' : 'lg:px-0'}`}>

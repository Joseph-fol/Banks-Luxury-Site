                ...
                <div className='w-full max-w-6xl bg-[#ffeee9] px-6 md:px-10 mx-auto py-10'>
                    ...
                    <div className='flex gap-5 flex-col md:flex-row flex-wrap items-start md:items-center'>
                        <div className='w-full md:flex-1'>
                            ...
                            <select name="" id="" className='w-full bg-white p-4 my-2'>
                        ...
                        <div className='w-full md:flex-1'>
                            <label htmlFor="setLocation" className='font-normal'>Check-in Date</label><br />
                            <input type="date" className='w-full bg-white p-4 my-2'/>
                        </div>

                        <div className='w-full md:flex-1'>
                            <label htmlFor="setLocation" className='font-normal'>Check-out Date</label><br />
                            <input type="date" className='w-full bg-white p-4 my-2'/>
                        </div>
